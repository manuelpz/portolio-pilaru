        ...
        <AdminValidation component={<div className="flex justify-center">
            <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
                <div className="text-center">
                    <h2 className="text-2xl font-semibold">Recomendar una nueva SERIE/PELICULA</h2>
                </div>
                <form encType="multipart/form-data" className="space-y-4">
                    <div>
                        <label htmlFor="text" className="block text-gray-600 font-bold">Titulo de la serie/pelicula</label>
                        <input
                            type="text"
                            id="titulo"
                    ...
                    <div>
                        <label htmlFor="text" className="block text-gray-600 font-bold">Breve descripcion</label>
                        <textarea
                            id="descripcion"
                            className="mt-1 p-2 w-full border rounded-md"
                            placeholder="Escribe una pequeña sinopsis ¿De qué trata la serie/pelicula?"
                            value={descripcion}
                    ...
                    <div>
                        <label htmlFor="text" className="block text-gray-600 font-bold">¿Hay URL a la serie/pelicula?</label>
                        <input type="text"
                            id="url"
                            className="mt-1 p-2 w-full border rounded-md"
