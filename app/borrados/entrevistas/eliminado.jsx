...
export default function Eliminado() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const res = await fetch(`https://portfolio-back-dev-pkbc.1.us-1.fl0.io/api/entrevistas`)
    ...
    const eliminarElemento = async (id) => {
        setIsLoading(true)
        try {
            await fetch(`https://portfolio-back-dev-pkbc.1.us-1.fl0.io/api/entrevistas/${id}`, {
                method: 'DELETE'
            })
                    ...
                    <div key={index} className="grid grid-cols-3 justify-items-center items-center border-blue-200 border-b-4 pb-6 mt-6">
                        ...
                        >
                            <div className="flex flex-col justify-center items-center">
                                <p className="text-center">¿Estás seguro de que quieres eliminar esta entrevista?</p>
